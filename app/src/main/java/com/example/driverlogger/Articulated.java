...
public class Articulated extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.articulated, container, false);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    newHelper.insertLog("articulated", sname, srego, startTime, firstBrk, secBrk, endTime);
...
//                i.putExtra("vehicle","articulated" );
//                startActivity(i);
                Bundle bundle = new Bundle();
                bundle.putString("vehicle","articulated");
