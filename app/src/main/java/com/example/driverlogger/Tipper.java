...
public class Tipper extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.tipper, container, false);
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                else
                {
                    ...
                    newHelper.insertLog("tipper", sname, srego, startTime, firstBrk, secBrk, endTime);
...
//                i.putExtra("vehicle","tipper" );
//                startActivity(i);
                Bundle bundle = new Bundle();
                bundle.putString("vehicle","tipper");
...
//                }
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Fragment fragment= new Articulated();
                FragmentTransaction transaction = getFragmentManager().beginTransaction();
                transaction.replace(R.id.fragment1, fragment); // fragmen container id in first parameter is the  container(Main layout id) of Activity
                transaction.addToBackStack(null);  // this will manage backstack
                transaction.commit();
